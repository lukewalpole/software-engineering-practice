...
public class TaskAllocationDataBase {
	...
	public ArrayList<Task> getAllTasks() {
		...
		String sqlStatement= new String(" SELECT task_id, task_type, task_desc, task_startDate, task_status, task_deadline, task_expectedDays , tech_id, task_endDate, notes  FROM task;");
