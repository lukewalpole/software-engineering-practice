...
public class TaskAllocationApp {
	...
	public TaskAllocationApp(DBConnection database, LogInLauncher newLogInLauncher) {
		logInLauncher=newLogInLauncher;
	/** Pass the database connection from Task8.LogInLauncher **/
		dbQuery= new TaskAllocationDataBase(database);
