...
public class EditTech extends JFrame {

	private static final long serialVersionUID = 1L;
	protected JPanel contentPane;
	protected JTextField TechIDField;
	protected JTextField FirstNameField;
	protected JTextField LastNameField;
	protected JTextField TechAgeField;
	protected JTextField TechSkillsField;
	protected JTextField HealthStatusField;
	...
	public EditTech(LogInLauncher newLauncher, TechList newTechList ) {
		...
		//Method to edit a technician in DB
		JButton btnAddTech = new JButton("Edit");
		btnAddTech.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		
				//get all the values passed from TechList Class
						...
						try {
							...
							int age=Integer.parseInt(newAge);
							      ...
							      //add a new tech in the database by calling launcher.dbQuery.addTech from LogInDatabase Class 
									launcher.dbQuery.editTech(techID, firstName, lastName, age, techSkills, healthStatus);
